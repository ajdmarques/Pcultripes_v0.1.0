## This is the hierfstat::genind2heirfstat function on developmental GitHub repo
## https://github.com/jgx65/hierfstat/
## as of the commit: d83ac6640775408484bef70dade9e5170ac44cd1
...
#' @export
##########################################################
genind2hierfstat2 <- function(dat,pop=NULL){
