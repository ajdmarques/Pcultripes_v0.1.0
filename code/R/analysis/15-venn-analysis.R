...
{# Generate Venn diagrams
  VennDiagram::venn.diagram(x = list(SE, BS, PA),
  ...
  VennDiagram::venn.diagram(x = list(BE, SB, LF, RD),
                            category.names = c("Bayenv" , "SamBada" , "LFMM", "RDA"),
                            ...
                            cat.dist = c(0.35, 0.35, 0.12, 0.12),
                            cat.fontfamily = "sans",
                            #rotation = 1
  )
  # Method comparisons
  VennDiagram::venn.diagram(x = list(unique(c(BS,SE,PA)), 
                                     unique(c(BE,SB,LF,RD)),
                                     MM),
                            category.names = c("OA" , "EAA" , "MEM"),
